...
class Main extends PluginBase implements Listener {
    ...
    private $myEnchants = [0 => "Protection",
        ...
        103 => "Gooey",
        119 => "Hallucination",
        // 116 => "Headless", not currently in recent piggy ce build.
        // 106 => "IceAspect", not currently in recent piggy ce build.
        100 => "Lifesteal",
        123 => "Lightening",
        124 => "LuckyCharm",
        104 => "Poison",
        // 107 => "Shockwave", not currently in recent piggy ce build.
        111 => "Vampire",
        115 => "Wither",
        306 => "Autoaim",
        311 => "Blaze",
        300 => "Bombardment",
        309 => "Bountyhunter",
        // 302 => "Firework" not currently in recent piggy ce build.
        313 => "Grappling",
        312 => "Headhunter",
        310 => "Healing",
        316 => "Homing",
